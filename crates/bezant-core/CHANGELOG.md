...
## [0.2.0](https://github.com/isaacrowntree/bezant/releases/tag/bezant-core-v0.2.0) - 2026-05-03

### Other

- subscription handles + cancel API + concrete split types
- prelude module + non_exhaustive on AuthStatus/TickleResponse + Default builder
