...
`rules` | [ContractRules](ContractRules.md)

## Example

```typescript
import type { GetInfoAndRules200Response } from 'bezant-client'
...
const example = {
  ...
  "rules": null,
} satisfies GetInfoAndRules200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetInfoAndRules200Response
