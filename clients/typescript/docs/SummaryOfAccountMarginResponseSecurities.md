...
```typescript
import type { SummaryOfAccountMarginResponseSecurities } from 'bezant-client'
...
} satisfies SummaryOfAccountMarginResponseSecurities
...
const exampleParsed = JSON.parse(exampleJSON) as SummaryOfAccountMarginResponseSecurities
