...
```typescript
import type { IRAPrimaryBeneficiary } from 'bezant-client'
...
const example = {
  ...
  "w8Ben": null,
  "w9": null,
} satisfies IRAPrimaryBeneficiary
...
const exampleParsed = JSON.parse(exampleJSON) as IRAPrimaryBeneficiary
