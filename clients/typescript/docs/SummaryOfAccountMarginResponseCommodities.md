...
```typescript
import type { SummaryOfAccountMarginResponseCommodities } from 'bezant-client'
...
} satisfies SummaryOfAccountMarginResponseCommodities
...
const exampleParsed = JSON.parse(exampleJSON) as SummaryOfAccountMarginResponseCommodities
