...
`accountId` | string
`contributions` | [Array&lt;QueryIRAContributionsResultAllOfContributions&gt;](QueryIRAContributionsResultAllOfContributions.md)
`iraType` | string
`year` | string
...
```typescript
import type { QueryIRAContributionsResult } from 'bezant-client'
...
const example = {
  ...
  "iraType": null,
  "year": null,
} satisfies QueryIRAContributionsResult
...
const exampleParsed = JSON.parse(exampleJSON) as QueryIRAContributionsResult
