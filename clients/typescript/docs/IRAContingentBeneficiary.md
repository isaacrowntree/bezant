...
```typescript
import type { IRAContingentBeneficiary } from 'bezant-client'
...
const example = {
  ...
  "w8Ben": null,
  "w9": null,
} satisfies IRAContingentBeneficiary
...
const exampleParsed = JSON.parse(exampleJSON) as IRAContingentBeneficiary
