...
```typescript
import type { QueryIRAContributionsResponse } from 'bezant-client'
...
const example = {
  ...
  "status": 202,
} satisfies QueryIRAContributionsResponse
...
const exampleParsed = JSON.parse(exampleJSON) as QueryIRAContributionsResponse
