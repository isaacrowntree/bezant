...
```typescript
import type { SuccessfulTickleResponse } from 'bezant-client'
...
const example = {
  ...
  "ssoExpires": null,
  "userId": null,
} satisfies SuccessfulTickleResponse
...
const exampleParsed = JSON.parse(exampleJSON) as SuccessfulTickleResponse
