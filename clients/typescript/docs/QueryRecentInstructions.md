...
```typescript
import type { QueryRecentInstructions } from 'bezant-client'
...
} satisfies QueryRecentInstructions
...
const exampleParsed = JSON.parse(exampleJSON) as QueryRecentInstructions
