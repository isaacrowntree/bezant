...
```typescript
import type { AssociatedIndividual } from 'bezant-client'
...
const example = {
  ...
  "w8Ben": null,
  "w9": null,
} satisfies AssociatedIndividual
...
const exampleParsed = JSON.parse(exampleJSON) as AssociatedIndividual
