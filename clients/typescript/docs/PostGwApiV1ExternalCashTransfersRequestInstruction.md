...
# PostGwApiV1ExternalCashTransfersRequestInstruction
...
```typescript
import type { PostGwApiV1ExternalCashTransfersRequestInstruction } from 'bezant-client'
...
} satisfies PostGwApiV1ExternalCashTransfersRequestInstruction
...
const exampleParsed = JSON.parse(exampleJSON) as PostGwApiV1ExternalCashTransfersRequestInstruction
