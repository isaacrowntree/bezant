...
```typescript
import type { IserverHistoryMidpointResponse } from 'bezant-client'
...
const example = {
  ...
  "travelTime": null,
  "volumeFactor": null,
} satisfies IserverHistoryMidpointResponse
...
const exampleParsed = JSON.parse(exampleJSON) as IserverHistoryMidpointResponse
